binMAEE = function (y, X, id, Z, maxiter, epsilon, printrange, alpadj, shrink, makevone) {
  ...
  SCORE = function (Ustarold, beta, alpha, y, X, Z, n, p, 
                    q, flag, rangeflag, VEEFLAG, NPSDFLAG, 
                    NPSDADJFLAG) {
    ...
    return(list(U = U, UUtran = UUtran, Ustar = Ustar,flag = flag,
                rangeflag = rangeflag, VEEFLAG = VEEFLAG,
  ...
  #####################################################################################
  MAKEVAR = function (Ustarold, beta, alpha, y, X, Z, 
                      n, p, q, VEEFLAG, ROBFLAG, NPSDADJFLAG) {
  ...
  FITPRENTICE = function(y, X, Z, n, maxiter, epsilon, VEEFLAG, SINGFLAG, ROBFLAG,
    ...
    while ((niter <= maxiter) & (max(abs(delta)) > epsilon)) {
      ...
      repeat{
        ...
        NPSDFLAG = 0
        NPSDADJFLAG = 0
        SCORE_RES = SCORE(Ustarold, beta, alpha, y, X, Z, n, p, q, flag = 0, 
