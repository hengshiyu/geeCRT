cpgee_nex = function(y, X, id, m, family, maxiter, epsilon, printrange,
    alpadj) {
    ...
    # for cluster m: vector of cluster-period sizes
    ...
    ##################################################################################### MODULE: getalpha0, getalpha1 (getalpha0, getalpha1) updates
    ##################################################################################### values for correlation parameters

    # INPUT alpdata0: dataset built for estimating alpha0 alpdata1:
    # dataset built for estimating the rest

    # OUTPUT alpha0, alpha1:correlaion parameters
